...
$(document).delegate('#Scout_Select', 'click', function() /* AFTER SCOUT WAS SELECTED */
{
    ...
    setTimeout(function () {
        $("<p>Chapter 1: </p>").hide().appendTo("#div_Chat_Log_Text_Title").fadeIn(1000);
    }, 1);

    setTimeout(function () { /*Just Use This??*/
        $("Scout").hide().appendTo("#div_Chat_Log_Text_Title").fadeIn(1000);
        /*
        setTimeout(function () {
        ...
        */ /*TYPED CHAPTER NAME IS HERE. FIND OUT HOW YOU CAN FADE IT IN!!!!!!!!/!/!1!111111
        ...
        setTimeout(function () {
            /*$("#div_Chat_Log_Text").append("Under holy judgement, a trial is being held, a trial that only the most desperate of prisoner wish for: a Trial by Champion.").fadeIn(5000);*/
        ...
        setTimeout(function () {
            /*$("#div_Chat_Log_Text").append("You are thrown down a trapdoor, a pile of hay broke your fall. The only light here is coming from above.<br>You sat in silence for a couple of seconds, bracing yourself for the trial. 'Good luck,' said the warden as he shut the wooden door.");*/
            $("<p>You are thrown down a trapdoor, a pile of hay broke your fall. The only light here is coming from above.<br>You sat in silence for a couple of seconds, bracing yourself mentally for the trial. 'Good luck,' said the warden as he shut the wooden door.</p>").hide().appendTo("#div_Chat_Log_Text").fadeIn(1000);
        }, 4000);
