...
$(document).ready(function(){
    $(document).one('click', '#scout_Find_Door_1', function(){
        ...
        setTimeout(function () {
            $("<p>Your hands guide you. A day before now, the warden said that this place is a great maze, that there is only one exit.</p>").hide().appendTo("#div_Chat_Log_Text").fadeIn(1000);
        }, 3000);
        ...
        setTimeout(function () {
            $("<p>You were told that other prisoners are here as well, they were supposedly dropped down here at the same time as you. But worse than that is a being that roams the maze. They call it the 'Champion'. Rumored to be some sort of beast.</p>").hide().appendTo("#div_Chat_Log_Text").fadeIn(1000);
        }, 6000);
