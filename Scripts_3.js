/**
 * Created by 17svo on 5/18/2017. EVEE
 */
$(document).ready(function(){
    $(document).one('click', '#Evee_Select', function() {
        ...
        $("#div_Chapter_TEXT").text("Chapter 1: Evee");
        ...
        setTimeout(function () {
            $("<span>Evee</span>").hide().appendTo("#div_Chat_Log_Text_Title").fadeIn(1000);
        }, 1000);
